...
export default function page() {
  ...
  <div className="container px-5 py-24 mx-auto">
    {/* <div className="flex flex-wrap -mx-4 -mb-10 text-center "> */}
      <div className="sm:w-1/2 mb-10 px-4 bg-gray-100 rounded-lg p-7 m-auto">
        ...
        <button className="flex mx-auto mt-6 text-white bg-purple-500 border-0 py-2 px-5 focus:outline-none hover:bg-purple-600 rounded">Button</button>
      </div>
